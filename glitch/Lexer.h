...
enum {
// Lexicons Directives used to describe a grammar
	D_UNKNOWN = 0,
	D_NONE,
	D_NULL,
    D_GRAMMAR_COMMENT,
	...
	D_USER_CODE_HINTS,
	D_USER_CODE_DEBUG,
	D_USER_CODE_CALL_THROUGH,
	D_USER_CODE_CALL_THROUGH_COMMENTED,
	LAST_DIRECTIVE,
};

const EnumStringArray grammar_directives[LAST_DIRECTIVE] = {
		"DIRECTVE_UNKNOWN",
		"DIRECTIVE_NONE",
		"\0",
		"%#",
...
protected:
	...
	void Process_D_USER_CODE_HINTS(void);
	void Process_D_USER_CODE_DEBUG(void);
	void Process_D_USER_CODE_CALL_THROUGH(void);
	void Process_D_USER_CODE_CALL_THROUGH_COMMENTED(void);
...
private:
    ...
    bool some_grammar_defined;				// set if %n terms used anywhere to define a grammer
};
