...
enum {
	...
	E_ENUM_START_NOT_ZERO_AND_TERMINATING_MEMBER_TRUE,
	...
	E_GRAMMAR_WITHOUT_ACTION,
	LAST_ERROR,
};

const EnumStringArray error_strings[LAST_ERROR] = {
		...
		"Enum starting member must be 0 if terminating members is set to ON",
		...
		"%n grammar directives used but no %actions are used - parser useless.",
};
